...
public class IntentKeys {
    ...
    public static final String PROFILE_NAME = "com.zebra.datawedgebarcodehighlightingsample";
    ...
    public static final String DECODE_DATA = "com.symbol.datawedge.decode_data";
    public static final String DATA = "com.symbol.datawedge.data";
